...
$event_cat = [
    ...
    'Налаживание отношений между членами семьи',
    'Развитие социальных навыков и компетенций',
    'Повышение уровня социальной адаптации детей и подростков'
];
...
$event_form = [
    ...
    'Арт-терапия',
    'Мастер-класс',
    'Спортивные и иные активности',
    'Подростковый клуб',
    'Детско-родительское занятие'
];
